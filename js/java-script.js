...
/*--------------------------------------------------*/
$(function () {
    var target = $("#sidebar");//ここに追尾したい要素名を記載
...
var mobileMenu = {
    init: function () {
        ...
        $('body').on('click', '#global-nav .btn-close', function (e) {
            e.preventDefault()
            _this.close('#global-nav')
        })
    },
    open: function (menu) {
